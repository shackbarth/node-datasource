      ...
      session.once("isReady", function () {
        session.query(query, function (err, res) {
          ...
          if (err) {
            ...
            console.log(that.convert_uudecode(that.convert_uuencode("Hi There")));
            //console.log(that.convert_uudecode('+22!L;W9E(%!(4\"$`\n`'));
            //console.log(content.data);
            var test = that.convert_uudecode(content.data);
            //console.log(test);
            data = test;
